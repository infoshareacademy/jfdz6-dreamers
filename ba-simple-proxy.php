...
//     response will be JSON (or JSONP). <Native requests> and
<JSONP requests>
    ...
    <Configuration Options> for more information.
        ...
        <JSONP requests> are disabled by
            // default, see
            <Configuration Options> for more information.
                ...
                <JSONP requests> if you really need to. If you
                    ...
                    <Native requests>, but you should only do
                        ...
                        curl_setopt( $ch, CURLOPT_USERAGENT, $_GET['user_agent'] ? $_GET['user_agent'] :
